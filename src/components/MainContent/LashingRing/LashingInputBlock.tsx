...
interface LashingInputBlockProps {
  paramsArray: paramsArrayItem[];
  calculateFn: () => Action;
}

const LashingInputBlock: FC<LashingInputBlockProps> = ({ paramsArray, calculateFn }) => {
  const {
    conFactor,
    conFactorText,
    earParams: {
    ...
    toogler,
    jumperCustom,
  } = useAppSelector((state) => state.lashingRing);
  ...
  return (
    <div className={stl.initialData}>
      ...
      <InputBlock inputArrayParams={inputArrayParams} calculateFn={calculateLashingRing} />
